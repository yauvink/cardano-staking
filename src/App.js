...
export default function App() {
  ...
  const [recipientAddress, setRecipientAddress] = useState(
    'addr_test1qqsjrwqv6uyu7gtwtzvhjceauj8axmrhssqf3cvxangadqzt5f4xjh3za5jug5rw9uykv2klc5c66uzahu65vajvfscs57k2ql'
  );
    ...
    recipients: [
      {
        ...
        amount: '3',
        mintedAssets: [
          { assetName: 'MyNFT', quantity: '1', policyId: 'Example PolicyID', policyScript: 'ExamplePolicy' },
        ],
      },
    ],
  });
    ...
    <>
      <div className="container">
        ...
        <div className="container">
          ...
          <div className="row">
            <button className={`button ${connected ? 'success' : ''}`} onClick={connect}>
              {' '}
          ...
          <div className="row">
            <button className={`button ${address ? 'success' : ''}`} onClick={getAddress}>
              {' '}
              Get Your Address{' '}
            </button>
            {address && (
        ...
        <div className="row">
          <button className={`button ${complextxHash ? 'success' : ''}`} onClick={buildFullTransaction}>
            {' '}
            Build Transaction
          </button>
          <div className="column">
            ...
            <div className="item address">
              ...
              <textarea style={{ width: '400px', height: '500px' }} value={builtTransaction} />
            </div>
          </div>
        </div>
      </div>
